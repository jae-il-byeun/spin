...
public class MemberServiceImp implements MemberService{
	...
	public void emailAuthentication(String me_id,String me_email) {
		...
		String title = "[Spring]이메일 인증 입니다.";
		String content = 
				"다음 링크를 클릭해서 이메일 인증을 완료하세요.<br>"+
				"<a href='http://localhost:8080/spring/email?mo_num="
						+str+
						"mo_me_id="+me_id+"'>이메일 인증하기</a>";
		//이메일 전송
	...
	private String authenticationNumber() {
		...
		public boolean emailAuthenticationConfirm(MemberOKVO mok) {
			...
			//System.out.println("DB에서 가져온 인증 정보 : " + dbMok); 안되는지 확인가능
			if(dbMok != null) {
